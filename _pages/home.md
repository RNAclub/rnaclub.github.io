...
<div class="bgded overlay" style="background-image:url('{{ site.url }}{{ site.baseurl }}/images/guangzhou.jpg');padding-top:30px"> 
  <!-- ################################################################################################ -->
  <header id="header" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <div id="logo" class="one_quarter first">
      <h1><a href="index.html">&nbsp;&nbsp;Guangzhou &nbsp;&nbsp;RNA club</a></h1>
    </div>
  ...
  <div id="pageintro" class="hoc clear" style="padding-top:0px;padding-bottom:10px"> 
    ...
    <article>
      <p>&nbsp;&nbsp;Academic Salon</p>
      <h3 class="heading" ><font color="#EEB9AE">&nbsp;RNA Society</font></h3>
...
<div class="wrapper coloured">
  <section id="testimonials" class="hoc container clear"> 
    ...
    <img src="{{ site.url }}{{ site.baseurl }}/images/teampic/Chichau_photo.jpg" style="max-width: 24%;">
      ...
      <em style="padding-bottom:20px">Principal Investigator at Guangzhou Laboratory</em></article>
    <article class="col-sm-6">
