  ...
  <section class="hoc container clear"> 
   ...
   <li class="one_half">
        <article>
          <div class="excerpt">
            <ul class="nospace meta">
              <li><iconify-icon icon="mdi:user-box" style="color: #719B67;"></iconify-icon> <a href="#"><font size="3">Chun Kit KWOK</font></a></li>
              <li><iconify-icon icon="mdi:tags" style="color: #719B67;"></iconify-icon> <a href="https://www.kitkwok.com/">Department of Chemistry and State Key Laboratory of Marine Pollution City University of Hong Kong,Hong Kong SAR, China</a></li>
            </ul>
            <h6 class="heading" style="padding-top:10px">Identification, characterization and targeting of RNA G-quadruplex structures</h6>
            <p style="padding-top:10px">  Explore the role of RNA structures and interactions in biology, particularly the function of G4 structures/interactions and non-coding RNA structures/interactions in the mammalian transcriptome and their relevance to gene regulation, RNA metabolism, and disease.
            [<a href="https://www.kitkwok.com/">&hellip;</a>]</p>
            <footer ><a href="#">Read More..</a></footer><br>
          </div>
          <time datetime="2023-06-16T10:00+11:30"><strong>16</strong> <em>June</em><em>2023</em></time>
        </article>
      </li>
...
<div class="wrapper row2">
  <section class="hoc container clear"> 
    ...
    <li class="one_third" style="border-left:1px solid #f0f0f0">
        <article>   
            <!--<p style="padding-top:10px"> Following the excellent presentation by Prof.<strong> Yi Xing</strong> from the John Innes Centre in the UK, at 10am 2023-06-16, Professor <strong> Chun Kit KWOK </strong> from Department of Chemistry and State Key Laboratory of Marine Pollution City University of Hong Kong, will give a talk on < Identification, characterization and targeting of RNA G-quadruplex structures > to the Guangzhou RNA club of the International RNA Association. Dr. Chun Kit KWOK focus on exploring the role of RNA structures and interactions in biology, particularly the function of G4 structures/interactions and non-coding RNA structures/interactions in the mammalian transcriptome and their relevance to gene regulation, RNA metabolism, and disease.<br><br>
            Zoom Meeting ID: 375 375 1031, Passcode: Qcd8Vs<br>
