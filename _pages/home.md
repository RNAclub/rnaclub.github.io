        ...
        <article>
          <div class="excerpt">
            <ul class="nospace meta">
              <li><iconify-icon icon="mdi:user-box" style="color: #719B67;"></iconify-icon> <a href="#">张强锋</a></li>
              <li><iconify-icon icon="mdi:tags" style="color: #719B67;"></iconify-icon> <a href="#">清华大学</a></li>
            </ul>
            <h6 class="heading" style="padding-top:10px">Computational prediction and CRISPR-Cas12a knockout and rescue and mechanism of some specific RNA assays identify many functionally conserved IncRNAs from zebrafish to human.</h6>
            <p style="padding-top:10px"> [<a href="#">&hellip;</a>]</p>
            <footer ><a href="#">Read More..</a></footer><br>
          </div>
          <time datetime="2022-11-18T09:30+11:30"><strong>18</strong> <em>Nov</em><em>2022</em></time>
        </article>
      </li>
      <li class="one_half">
        <article>
          <div class="excerpt">
            <ul class="nospace meta">
              <li><iconify-icon icon="mdi:user-box" style="color: #719B67;"></iconify-icon> <a href="#">任艾明</a></li>
              <li><iconify-icon icon="mdi:tags" style="color: #719B67;"></iconify-icon> <a href="#">浙江大学</a></li>
            </ul>
            <h6 class="heading" style="padding-top:10px">Demystifying the architecture and mechanism of some specific RNA molecules.</h6>
            <p style="padding-top:10px"> [<a href="#">&hellip;</a>]</p>
            <footer><a href="#">Read More</a></footer><br>
          </div>
          <time datetime="2022-11-18T09:30+11:30"><strong>18</strong> <em>Nov</em><em>2022</em></time>
  ...
  <section class="hoc container clear"> 
    ...
    <ul class="nospace group latest" style="padding-right:0px;">
     <li class="two_third first" >
        ...
        <img src="{{ site.url }}{{ site.baseurl }}/images/newspic/event221125.jpg" style="max-width: 54%;padding-left:5px;padding-right:5px;"> 
    </li>
    <li class="one_third" style="border-left:1px solid #f0f0f0">
        <article>   
            <p style="padding-top:10px"> RNA医学前沿学术报告，会议形式为网络会议，腾讯会议与bilibili同步直播, 每位PI的报告时间45-50分钟，讨论10-15分钟。<br><br>同时也是今年新入选的Guangzhou RNA club的预热会议。欢迎老师同学参加。<br><br>有奖参与：<br>凭参会截图，与个人信息发送到 shi_yaohuang@gzlab.ac.cn <br><br>Guangzhou RNA Club将选取5名学生/博士后免费获得 RNA Society trainee memberships<br>(强烈建议有意愿参加The 28th Annual Meeting of the RNA Society in Singapore的同学申请）</p>                   
        </article>
    </li> 
    </ul>
  </section>
...
<div class="wrapper coloured">
  <section id="testimonials" class="hoc container clear"> 
    ...
    <div class="sectiontitle" style="margin-bottom: 40px">
      <p class="nospace font-xs">The great</p>
