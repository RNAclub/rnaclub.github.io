    ...
    <div class="three_quarter">
      <ul class="nospace clear">
        <li class="one_third first">
          <div class="block clear"><a href="#"><i class="fa fa-wechat"></i></a> <span><strong>Found more:</strong> wechat :GzRNA </span></div>
        </li>
        <li class="one_third">
          <div class="block clear"><a href="#"><i class="fas fa-envelope"></i></a> <span><strong>Send us a mail:</strong> shi_yaohuang@gzlab.ac.cn</span></div>
        </li>
        <li class="one_third">
...
d.m.j.lilley@dundee.ac.uk</a></li>
            ...
            <h6 class="heading" style="padding-top:10px">The extent of RNA catalysis – are there any limits?</h6>
            <p style="padding-top:10px"> The RNA world hypothesis for the early development of life on the planet requires that RNA molecules (ribozymes) could have catalysed a wide variety of chemical reactions. [<a href="{{ site.url }}{{ site.baseurl }}/docs/2022-08-19-David.html">&hellip;</a>]</p>
            <footer ><a href="{{ site.url }}{{ site.baseurl }}/docs/2022-08-19-David.html">Read More..</a></footer>
          </div>
          <time datetime="2022-08-19T08:15+00:00"><strong>19</strong> <em>Aug</em></time>
        </article>
      </li>
      <li class="one_half">
        <article>
          <div class="excerpt">
            ...
            <h6 class="heading" style="padding-top:10px">Eleifend semper nisl sed</h6>
    ...
    <footer class="center"><a class="btn" href="{{ site.url }}{{ site.baseurl }}/events">View More</a></footer>
  </section>
</div>
<!-- -->
