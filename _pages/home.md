      ...
      <li class="one_half first">
        <article>
          <div class="excerpt">
            ...
            <p style="padding-top:10px"> The systematic discovery and functional mechanisms of long non-coding RNAs in tumorigenesis, development and stem cell reprogramming by uing bioinformatics tools and combining with RNAomics techniques accumulated in the laboratory over the years...[<a href="https://people.ucas.ac.cn/~runshengchen">&hellip;</a>]</p>
  ...
  <section class="hoc container clear"> 
    ...
    <ul class="nospace group latest" style="padding-right:0px;">
     <li class="two_third first" >
        <img src="{{ site.url }}{{ site.baseurl }}/images/newspic/event230104.png" style="max-width: 54%;padding-left:20px;padding-right:20px;">
    ...
    <li class="one_third" style="border-left:1px solid #f0f0f0">
        <article>   
            <p style="padding-top:10px"> 2023-01-04下午3点陈润生院士给国际RNA协会广州RNA club做2023年第一场报告《大数据、人工智能与核酸药物》<br>腾讯会议号：177-967-139 <br><br>点击专属链接入会，或添加至会议列表：https://meeting.tencent.com/dw/NxrNcsCBm7Nx，bilibili同步直播https://live.bilibili.com/26427894，详情请看广州RNA club网站rnaclub.rnacentre.org, 欢迎大家关注广州RNA club公众号GzRNA，大家1月4日不见不散！<br><br>
